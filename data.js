        ...
        blocks: [
          ...
          },
          {
            ...
            items: [
              ...
              "<strong>Médaillon JcJ</strong> : la réponse principale, déclenchable pendant le stun. Paladins : Bouclier divin. Mages : Transfert.",
              "<strong>Living Action Potion</strong> : se boit pendant le stun, le retire et immunise 5 s dans la foulée.",
              "<strong>Free Action Potion</strong> : immunité aux stuns pendant 30 s, mais <span class=\"warn\">à boire avant</span> — elle ne retire pas un stun déjà posé.",
              "<span class=\"warn\">Une seule potion à la fois :</span> en TBC elles partagent toutes une recharge de 2 min. Le temps de couverture se paie sur les potions de soin et de mana.",
