...
const SHADOW_RESIST = {
  ...
  paths: [
    {
      title: 'La voie complète — deux Cœurs des ténèbres, aucune gemme sacrifiée',
      total: '187 non buffé · 257 buffé · coût : 2 Cœurs des ténèbres',
      steps: [
        'Medallion of Karabor <span class="sr-n">+40</span> — vous l\'avez déjà, c\'est la quête d\'accès.',
        'Night\'s End <span class="sr-n">+40</span> + son enchantement de cape <span class="sr-n">+15</span> = <span class="sr-n">55</span>. <span class="warn">Cette cape coûte 1 Cœur des ténèbres.</span>',
        ...
        'Les brassards Cendrelangue de votre type d\'armure <span class="sr-n">+40</span> → <strong>187</strong>. <span class="warn">Deuxième Cœur des ténèbres.</span>',
        'Cap dépassé de 13 points, et vos châsses restent garnies de gemmes de stats.',
      ],
    },
    {
      title: 'La voie de secours — un seul Cœur des ténèbres, le manque comblé aux gemmes',
      total: '175 non buffé · 245 buffé · coût : 1 Cœur des ténèbres + 7 gemmes',
      steps: [
        'Le Cœur des ténèbres ne tombe qu\'au Temple Noir. Après un premier reset, beaucoup de joueurs n\'en auront qu\'un seul en poche. Cette voie est faite pour eux.',
        '<strong>Mettez ce Cœur sur la cape, pas sur les brassards.</strong> Les deux pièces apportent <span class="sr-n">+40</span>, mais la cape accepte en plus l\'enchantement Résistance à l\'Ombre supérieure <span class="sr-n">+15</span>. Le même Cœur vous rapporte donc <span class="sr-n">55</span> au lieu de <span class="sr-n">40</span>.',
        'Vous montez ainsi le même socle que la voie complète : Medallion of Karabor <span class="sr-n">+40</span>, Night\'s End enchantée <span class="sr-n">+55</span>, Glyph of Shadow Warding <span class="sr-n">+20</span>, quatre Shadow Armor Kit <span class="sr-n">+32</span>. Total : <strong>147</strong>.',
        'Il manque <strong>27 points</strong> pour atteindre les 174 requis. Sans brassards, la seule source restante est vos châsses.',
        '<strong>7 Void Sphere</strong> à <span class="sr-n">+4</span> chacune donnent <span class="sr-n">+28</span> et vous placent à <strong>175</strong>, soit <strong>245 en combat</strong>. Si vous n\'en trouvez pas, <strong>9 Prismatic Sphere</strong> à <span class="sr-n">+3</span> donnent <span class="sr-n">+27</span> et suffisent tout autant.',
        'Le prix à payer est réel : sept à neuf châsses ne portent plus de stats. Sur un soigneur ou un caster, cela représente une perte sèche de puissance des sorts ou d\'intelligence pendant tout le combat.',
        'Considérez donc cette voie comme <strong>transitoire</strong>. Dès que votre deuxième Cœur des ténèbres tombe, fabriquez les brassards de votre type d\'armure et remettez vos gemmes de stats : vous récupérez vos statistiques sans rien perdre en résistance.',
      ],
    },
  ],
  ...
  caveats: {
    ...
    items: [
      ...
      "Chaque craft Cendrelangue consomme <strong>1 Cœur des ténèbres</strong>, qui ne tombe qu'au Temple Noir. La cape et les brassards en demandent donc <strong>deux au total</strong> par joueur. Les autres composants (Void Crystal, Primal Life ×2, Primal Shadow ×2, plus le matériau du métier) s'achètent à l'hôtel des ventes.",
